...
class TextWithVoiceReplyWidget extends StatelessWidget {
  final Size size;
  final Map<String, dynamic> chatData;
  final Map<String, dynamic> chatListData;
  const TextWithVoiceReplyWidget({
    super.key,
    required this.size,
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: BuildVoicePreviewReplyWidget(
              chatReply: ChatReply.fromJson(chatData['reply_to']),
            ),
          ),
          Card(
